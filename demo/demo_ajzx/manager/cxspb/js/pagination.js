...
var Pagination = /** @class */ (function () {
    ...
    Pagination.prototype.jumper = function () {
        ...
        var jumper_go = this.createElement('span', '_jumper_go');
        jumper_go.innerText = 'GO';
        // var govalue = input.value;
        // jumper_go.addEventListener('click',function (e){console.log(input.value);
        //     // e.stopPropagation();
        //     // if (govalue !== _this.options.pageIndex)
        //     // { _this.handleChangePage(govalue);}
        //     // else{ alert('fasdfdsafdsa');}
        // });
        jumper.appendChild(jumper_go);
        return jumper;
    };
    // 选择页码
